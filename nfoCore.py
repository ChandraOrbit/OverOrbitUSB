...
def generalInfo():
  ...
  print "\n\n"
  print "GENERAL"
  print "OrbitUSB is designed to facilitate creating Arduino sketches for devices with the AtMega32U4 chipset"
  ...
  print "\nABOUT ME"
  print "You can find me on www.orbitsolusi.com"
  print "and on github at https://github.com/OrbitUSB"
  print "Thanks to: mywife for...alot"
  print "\n"
  raw_input("Please press Enter to return to the previous screen")
